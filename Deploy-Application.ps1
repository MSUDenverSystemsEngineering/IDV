...
Try {
	...
	[string]$appVendor = 'Unidata'
	[string]$appName = 'IDV'
	[string]$appVersion = '5.6'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '3.7.0.1'
	[string]$appScriptDate = '01/24/20120'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Execute-Process -Path "$dirFiles\idv_5_6_windows64_installer.exe" -Parameters "-q"
		...
		Remove-File -Path "C:\Users\Public\Desktop\IDV 5.6.lnk"
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Remove-Folder -Path "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Integrated Data Viewer 5.6" -ContinueOnError
		Remove-Folder -Path "C:\Program Files\IDV_5.6" -ContinueOnError
